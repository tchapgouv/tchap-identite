        ...
        <form id="kc-form-login" class="${properties.kcFormClass!}" onsubmit="login.disabled = true; return true;"
            ...
            <div class="${properties.kcFormGroupClass!}">
                <label for="codeInput" class="${properties.kcLabelClass!}">
                    ...
                    ${client.name} utilise Tchap pour assurer que seuls les agents publics
                    utilisent les services qui leur sont réservés. Ceci est une mesure de sécurité ${client.name}.
                </label>

                <input tabindex="1" id="codeInput" class="${properties.kcInputClass!} code-input" name="codeInput"
                       type="text" autofocus minlength="6" maxlength="8" required />
            </div>

            <div class="${properties.kcFormGroupClass!}">
                <label for="email" class="${properties.kcLabelClass!}">Je n'ai pas reçu le code.
                    <a href="">Me renvoyer un code</a>
                </label>
            </div>
