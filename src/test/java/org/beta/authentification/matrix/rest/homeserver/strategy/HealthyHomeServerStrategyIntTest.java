...
class HealthyHomeServerStrategyIntTest {
    ...
    void should_get_healthy_client_fail_with_no_home_server(){
        ...
        assertThrows(MatrixRuntimeException.class,() -> new HealthyHomeServerStrategy(Environment.strToList(homeServerList)));
    }
    ...
    void should_get_healthy_client_fail_with_unavailable_home_server() {
        ...
        assertThrows(MatrixRuntimeException.class,() -> healthyHomeServerStrategy.findHomeServerByEmail(email));
    }
