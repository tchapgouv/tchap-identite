...
class SecureCodeTest {
    ...
    /**
     * GIVEN: a generated code WHEN: a new code is generated with the same length THEN: both codes
     * are different
     */
    @Test
    void should_create_new_code_each_time() {
        ...
        LOG.debugf(
                " %s : first code %s, second code %s",
                "should_create_new_code_each_time", firstCode, secondCode);
        assertThat(firstCode, not(equalTo(secondCode)));
    }

    /** GIVEN: a code of length 5 WHEN: it's make user friendly THEN: both code are same */
    @Test
    ...
    /**
     * GIVEN: a code of length 12 WHEN: it's make user friendly THEN: the code has been split into 3
    ...
    /**
     * GIVEN: a code of length 9 WHEN: it's make user friendly THEN: the code has been split into 3
     * dash-separated parts
     */
    @Test
    ...
    /**
     * GIVEN: a code of length 10 WHEN: it's make user friendly THEN: the code has been split into 3
     * dash-separated parts
     */
    @Test
    ...
    /**
     * GIVEN: a code of length 21 WHEN: it's make user friendly THEN: the code has been split into 6
     * dash-separated parts
     */
    @Test
    ...
    /**
     * GIVEN: correct code to login with valid time stamp WHEN: checked for validity THEN: returns
     * true
     */
    @Test
    ...
    /**
     * GIVEN: correct code to login with expired time stamp WHEN: checked for validity THEN: returns
     * false
     */
    @Test
    ...
    /**
     * GIVEN: correct code to login with too recent time stamp WHEN: checked for validity THEN:
     * returns false
     */
    @Test
