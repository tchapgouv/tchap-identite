...
class MatrixBotIntTest {
    ...
    class CreateDMTest {
        ...
        void shouldCreateADMAndAddDMEvent() {
            String destId = "@calev.eliacheff-beta.gouv.fr:i.tchap.gouv.fr";
            String roomId = userService.createDM(destId);
        ...
        void shouldNotCreateADMIfADMWithUserExists() {
            String destId = "@calev.eliacheff-beta.gouv.fr:i.tchap.gouv.fr";
            String roomId1 = userService.createDM(destId);
            String roomId2 = userService.createDM(destId);
    ...
    class SendingMessagesTest {
        ...
        void shouldSendAMessageToADMRoom() {
            String destId = "@calev.eliacheff-beta.gouv.fr:i.tchap.gouv.fr";
            String roomId = userService.createDM(destId);
            Assertions.assertDoesNotThrow(() -> userService.sendMessage(roomId, "Hello world"));
        }
    }
}
